...
#define RTL838X_L2_CTRL_0			(0x3200)
  #define RTL838X_L2_CTRL_0_HASH_ALGO		BIT(0)
  #define RTL838X_L2_CTRL_0_IPV4_MC_HASH_KEY	BIT(1)
  #define RTL838X_L2_CTRL_0_IPV6_MC_HASH_KEY	BIT(3)
  #define RTL838X_L2_CTRL_0_IP_MC_FVID_CMP	BIT(5)
  #define RTL838X_L2_CTRL_0_SA_ALL_ZERO_LR	BIT(6)
  #define RTL838X_L2_CTRL_0_LINK_DOWN_P_INVLD	BIT(6)
  #define RTL838X_L2_CTRL_0_IP_MC_DIP_CHK	BIT(7)
  #define RTL838X_L2_CTRL_0_MC_BC_SA_DROP	BIT(8)
  #define RTL838X_L2_CTRL_0_SECURE_SA		BIT(10)
  #define RTL838X_L2_CTRL_0_LUTCAM_EN		BIT(11)
  #define RTL838X_L2_CTRL_0_ZERO_SA_ACT		BIT(12)
  #define RTL838X_L2_CTRL_0_MC_BC_SA_TRAP	BIT(14)
